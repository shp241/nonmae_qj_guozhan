	...
	if (lib.rank) {
		...
		if (lib.rank.rarity) {
			const rarity = {
				...
				junk: ["qj_panfeng", "qj_zoushi", "qj_wangrong", "qj_tangji", "qj_liuchongluojun", "qj_jianshuo", "qj_fuwan", "yc_niujin", "yc_zhoucang", "yc_quexiaojiang", "yc_wenhu", "yc_mushun", "yc_huweijun", "yc_baimayicong", "yc_xiangbing", "yc_jinfanjun", "yc_bingzhoulangqi", "yc_huangjinleishi","yc_xiliangjingqi", "yc_fuxinsishi", "yc_xiyuanjun"],
			};
			for (let i in rarity) {
